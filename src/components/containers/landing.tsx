    ...
    <div className="relative min-h-svh flex mx-4 my-2 place-content-center flex-col">
        <div className="flex gap-2 max-w-full flex-wrap">
            ...
            <p className="basis-6/12 mx-auto min-w-80 text-center">
                Proficient Front-end Engineer with expertise in React, Angular,
                and JavaScript/TypeScript, that excels in crafting seamless user
                experiences and robust web solutions. Experienced with UI/UX
                design, backend development, and DevOps practices. Dedicated to
                user-centric design and mentorship. Committed to innovation and
                continuous learning. Poised to drive positive change in the
        ...
        <div className="self-center text-center absolute bottom-32 flex flex-col gap-1">
            <motion.nav
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.1, duration: 2.3 }}
                exit={{ opacity: 0 }}
            >
                <a href="#about">About </a>
                <Separator
                    className=" inline-block w-[0.5px] h-3 mx-2 bg-neutral-300"
                    decorative
            ...
            <motion.div
                ...
                exit={{ opacity: 0 }}
            >
                <Separator className="h-[0.5px] bg-neutral-300" />
            </motion.div>
        </div>
    </div>
);
